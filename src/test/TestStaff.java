...
public class TestStaff {
    ...
    public static void main(String[] args) {
        ...
        Cajero cajero = new Cajero("sebas", "oliveto", 1122334455, LocalDate.of(1993, 8, 7), LocalDate.of(2026, 8, 23),
                250, "noche");
        // String nombre, String apellido, long dni, LocalDate fechaNacimiento,
